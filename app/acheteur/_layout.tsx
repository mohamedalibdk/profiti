...
export default function AcheteurTabsLayout() {
  const insets = useSafeAreaInsets();

  // State pour le badge du panier
  ...
  useEffect(() => {
    ...
    // Ecoute en temps réel les changements sur le panier
    ...
    // Nettoyage du listener à la fermeture du composant
    return () => unsubscribe();
  }, [auth.currentUser]);
